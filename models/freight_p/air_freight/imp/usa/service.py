...
from models.freight_p.air_freight.imp.usa.model import pred_freight_model
from models.freight_p.air_freight.imp.imp_repository import la_imp_data, newyork_imp_data, chicago_imp_data, \
