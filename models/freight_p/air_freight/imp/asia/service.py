...
from models.freight_p.air_freight.imp.asia.model import pred_freight_model
from models.freight_p.air_freight.imp.imp_repository import kuala_imp_data, singapor_imp_data, hongkong_imp_data, \
