...
from models.freight_p.air_freight.imp.euro.model import pred_freight_model
from models.freight_p.air_freight.imp.imp_repository import frankfrut_imp_data
