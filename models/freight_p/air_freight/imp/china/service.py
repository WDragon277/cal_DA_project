...
from models.freight_p.air_freight.imp.china.model import pred_freight_model
from models.freight_p.air_freight.imp.imp_repository import pudong_imp_data, tianjin_imp_data, qingdao_imp_data, \
