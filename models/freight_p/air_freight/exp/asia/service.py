...
from models.freight_p.air_freight.exp.asia.model import pred_freight_model
from models.freight_p.air_freight.exp.exp_repository import kuala_exp_data, singapor_exp_data, hongkong_exp_data, \
