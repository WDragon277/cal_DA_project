...
from models.freight_p.air_freight.exp.china.model import pred_freight_model
from models.freight_p.air_freight.exp.exp_repository import frankfrut_exp_data
...
def save_euro_pred_exp():
    ...
    try:
        ...
        logger.info("프랑크푸르트 수출운임예측 데이터가 입력 되었습니다.")
    except Exception as e:
        logger.error("프랑크푸르트 수출운임예측 데이터 삽입에 오류가 발생하였습니다.")
