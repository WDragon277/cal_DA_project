...
list_indx_no = ['005', '002', '003', '004', '001']

data_bdi = {
    'crtn_dt' : current_day,
    'cach_tp_cd' : 'CNTR',
    'expo_cd': 'BDI',
    'expo_cd_nm': 'Baltic Dry Index',
...
chat_service.save_data_postdb(data_bdi)
...
data_scfi = {
    ...
    'cach_tp_cd' : 'CNTR',
    'expo_cd': 'SCFI',
    'expo_cd_nm': 'Shanghai Containerized Freight Index',
...
chat_service.save_data_postdb(data_scfi)
...
data_ccfi = {
    ...
    'cach_tp_cd' : 'CNTR',
    'expo_cd': 'CCFI',
    'expo_cd_nm': 'China Containerized Freight Index',
...
chat_service.save_data_postdb(data_ccfi)
...
data_hrci = {
    ...
    'cach_tp_cd' : 'CNTR',
    'expo_cd': 'HRCI',
    'expo_cd_nm': 'Howe Robinson Container Index',
...
chat_service.save_data_postdb(data_hrci)
...
data_kcci = {
    ...
    'cach_tp_cd' : 'CNTR',
    'expo_cd': 'KCCI',
    'expo_cd_nm': 'KOBC Container Composite Index',
...
chat_service.save_data_postdb(data_kcci)
