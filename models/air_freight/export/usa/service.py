...
from models.air_freight.export.exp_repository import la_exp_data, newyork_exp_data, chicago_exp_data, \
...
try:
    ...
    logger.info("pred_la_exp_js 데이터가 입력 되었습니다.")
except Exception as e:
    logger.error("pred_la_exp_js 데이터 삽입에 오류가 발생하였습니다.")

try:
    insert_air_pred(pred_newyork_exp_js)
    logger.info("pred_newyork_exp_js 데이터가 입력 되었습니다.")
except Exception as e:
    logger.error("pred_newyork_exp_js 데이터 삽입에 오류가 발생하였습니다.")

try:
    insert_air_pred(pred_chicago_exp_js)
    logger.info("pred_chicago_exp_js 데이터가 입력 되었습니다.")
except Exception as e:
    logger.error("pred_chicago_exp_js 데이터 삽입에 오류가 발생하였습니다.")

try:
    insert_air_pred(pred_sfo_exp_js)
    logger.info("pred_sfo_exp_js 데이터가 입력 되었습니다.")
except Exception as e:
    logger.error("pred_sfo_exp_js 데이터 삽입에 오류가 발생하였습니다.")

try:
    insert_air_pred(pred_atl_exp_js)
    logger.info("pred_atl_exp_js 데이터가 입력 되었습니다.")
except Exception as e:
    logger.error("pred_atl_exp_js 데이터 삽입에 오류가 발생하였습니다.")
